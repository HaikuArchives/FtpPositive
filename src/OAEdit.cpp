...
// Filters the BMessage sent to BTextView, a child BView of BTextControl.
// Intercept the ENTER key and ↓, ↑, and MakeFocus to the next or previous BView.
...
{
// Add filter to the BTextView.
// Enable monitoring of the ENTER key and arrow keys.
...
// Move focus
// If direction = true, move to next BView, false to move to previous BView.
