...
// Directory-first file name sorting function (requires modified BColumnListView)
...
// Start Drag and Drop out of View
bool TRemoteFileView::InitiateDrag(BPoint, bool)
{
	...
	// Send a script to tell the path of the drop destination Tracker window
	// -> Receive Reply in FTPWindow.cpp and start downloading
...
{
	// Ignore anything except outline_view (otherwise the display will be distorted)
