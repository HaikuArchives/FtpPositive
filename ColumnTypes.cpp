...
int BStringColumn::CompareFields(BField* field1, BField* field2, BRow* row1, BRow* row2)
{
...
int BDateColumn::CompareFields(BField* field1, BField* field2, BRow* row1, BRow* row2)
{
...
int BSizeColumn::CompareFields(BField* field1, BField* field2, BRow* row1, BRow* row2)
{
...
int BIntegerColumn::CompareFields(BField *field1, BField *field2, BRow* row1, BRow* row2)
{
...
int BBitmapColumn::CompareFields(BField* /*field1*/, BField* /*field2*/, BRow* /*row1*/, BRow* /*row2*/)
{
